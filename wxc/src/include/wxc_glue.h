...
bool       wxFont_GetUnderlined( TSelf(wxFont) _obj );
...
void       wxFont_SetUnderlined( TSelf(wxFont) _obj, bool underlined );
...
bool       wxWindow_DoPhase( TSelf(wxWindow) _obj, int phase );
...
bool       wxWindow_GetAutoLayout( TSelf(wxWindow) _obj );
...
bool        wxWindow_GetLabelEmpty( TSelf(wxWindow) _obj );
...
bool        wxWindow_PopupMenu( TSelf(wxWindow) _obj, TClass(wxMenu) menu, TPoint(x,y) );
